"""
Django settings for bananaid project.
...
MIDDLEWARE = [
    ...
    'bananaid.middelware.banid_middleware.BanIDMiddleware',

]

ROOT_URLCONF = 'bananaid.urls'
...
WSGI_APPLICATION = 'bananaid.wsgi.application'
